      ...
      <div className="md:ml-20 h-16 flex justify-between fixed bg-white  inset-x-0 top-0 drop-shadow z-50">
        ...
        <div className="flex items-center">
          <form className="sm:flex hidden mx-2">
            ...
            <input className="py-2 pr-4 pl-10 w-full shadow-sm sm:text-sm border border-blue-400 rounded-l-md" id="search" type="text" placeholder="Search" onChange={handleQuery} />
            <button
          ...
          <div className="relative">
            <button className="flex items-center mx-2" id="basic-button" aria-controls={open ? "basic-menu" : undefined} aria-haspopup="true" aria-expanded={open ? "true" : undefined} onClick={handleClick}>
            ...
            >
              <div className="w-full">
                ...
                <div className="my-4 mx-2 flex sm:hidden">
                  <input className="py-2 px-4 w-full shadow-sm sm:text-sm border border-blue-400 rounded-l-md" id="search" type="text" placeholder="Search" />
